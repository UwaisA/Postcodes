...
class FormatterFixedOptionalSeparatorsTest {
    ...
    fun `Include optional separators formats to add separators`() {
        val formatterBrazil = Formatter.create(Validator.create(localeBrazil, Options(OptionalSeparator.INCLUDE)))
        ...
        val formatterUK = Formatter.create(Validator.create(Locale.UK, Options(OptionalSeparator.INCLUDE)))
    ...
    fun `Don't include optional separators formats to remove separators`() {
        val formatterBrazil = Formatter.create(Validator.create(localeBrazil, Options(OptionalSeparator.EXCLUDE)))
        ...
        val formatterUK = Formatter.create(Validator.create(Locale.UK, Options(OptionalSeparator.EXCLUDE)))
