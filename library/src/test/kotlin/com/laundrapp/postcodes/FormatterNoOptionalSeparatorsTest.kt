...
class FormatterFixedOptionalSeparatorsTest {
    ...
    fun `Include optional separators formats to add separators`() {
        val formatterBrazil = Formatter(Validator(localeBrazil, Options(OptionalSeparator.INCLUDE)))
        ...
        val formatterUK = Formatter(Validator(Locale.UK, Options(OptionalSeparator.INCLUDE)))
    ...
    fun `Don't include optional separators formats to remove separators`() {
        val formatterBrazil = Formatter(Validator(localeBrazil, Options(OptionalSeparator.EXCLUDE)))
        ...
        val formatterUK = Formatter(Validator(Locale.UK, Options(OptionalSeparator.EXCLUDE)))
