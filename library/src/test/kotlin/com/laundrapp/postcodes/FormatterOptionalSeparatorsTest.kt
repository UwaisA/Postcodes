...
class FormatterOptionalSeparatorsTest {
    ...
    fun `Accept either optional separators formats to leave out separators that have been missed`() {
        val formatterBrazil = Formatter.create(Validator.create(localeBrazil, Options(OptionalSeparator.ACCEPT_EITHER)))
        ...
        val formatterUK = Formatter.create(Validator.create(Locale.UK, Options(OptionalSeparator.ACCEPT_EITHER)))
