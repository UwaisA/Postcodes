...
class FormatterOptionalSeparatorsTest {
    ...
    fun `Accept either optional separators formats to leave out separators that have been missed`() {
        val formatterBrazil = Formatter(Validator.create(localeBrazil, Options(OptionalSeparator.ACCEPT_EITHER)))
        ...
        val formatterUK = Formatter(Validator.create(Locale.UK, Options(OptionalSeparator.ACCEPT_EITHER)))
